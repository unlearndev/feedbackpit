...
/**
* @see \App\Modules\Internal\Http\Controllers\IdeaMergeController::store
* @see app/Modules/Internal/Http/Controllers/IdeaMergeController.php:13
* @route '/internal/ideas/{idea}/merge'
*/
...
const IdeaMergeController = { store }

export default IdeaMergeController